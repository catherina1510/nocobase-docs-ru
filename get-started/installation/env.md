...
## Прочие переменные окружения, предоставляемые плагинами

### WORKFLOW_SCRIPT_MODULES

Список доступных модулей узла JavaScript для Рабочего процесса. Подробнее см. "[Узел JavaScript: использование внешних модулей](/workflow/nodes/javascript#using-external-modules)".

### WORKFLOW_LOOP_LIMIT

Максимальное ограничение числа итераций для узлов цикла Рабочего процесса. Подробнее см. "[Узел цикла](/workflow/nodes/loop#WORKFLOW_LOOP_LIMIT)".
