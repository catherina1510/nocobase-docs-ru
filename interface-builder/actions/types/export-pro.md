...
Эта функция предоставляется коммерческим плагином `plugin-action-export-pro`. Подробнее см. коммерческую лицензию.
...
| Поля связей<br>(один-к-одному, один-ко-многим,<br>многие-к-одному, многие-ко-многим) | Первичный ключ / уникальное ограничение | 500 000 | 15-30 минут |

Поля связей снижают производительность.
