...
Блок «Сетка карточек» отображает сводную информацию записей данных в формате карточек. Он поддерживает настройку количества колонок для разных размеров экрана, чтобы обеспечить удобное отображение на различных устройствах.
...
Для дополнительной информации см. [Область данных](/interface-builder/blocks/block-settings/data-scope)

### Задать количество колонок в строке

![20251023210137](https://static-docs.nocobase.com/20251023210137.gif)

Поддерживается настройка количества колонок для разных размеров экрана.
...
Для настройки полей блока «Сетка карточек» см. [Поля деталей](/interface-builder/fields/generic/detail-form-item)
