...
`ctx.state` используется для обмена данными в цепочке промежуточного программного обеспечения.
...
- Использование `ctx` в промежуточных обработчиках и действиях позволяет удобно обрабатывать запросы, ответы, разрешения, логи и базу данных.
