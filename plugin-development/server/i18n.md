...
Плагины NocoBase поддерживают многоязычную интернационализацию (i18n) как для клиентской, так и для серверной части. Благодаря унифицированному механизму вы можете легко реализовать многоязычный контент в плагинах.
...
### Использование в промежуточном обработчике
