...
* Один и тот же язык может иметь несколько региональных вариантов, например:
  ...
  * `fr-FR` (французский Франции), `fr-CA` (канадский французский)
...
* Языковые конфигурации обычно используются для:
  ...
  * **Загрузка файлов интернационализации**: загружать соответствующие JSON-файлы переводов на основе `кода локали`.

* При добавлении нового языка необходимо:

  1. Следовать стандарту BCP 47 при определении `кода локали`;
