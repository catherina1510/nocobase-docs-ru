...
Данные, обновляемые узлом «Обновить запись» в рабочем процессе, не заполняют автоматически поле «Последнее обновление пользователем». При необходимости значение этого поля нужно настроить вручную.
:::
