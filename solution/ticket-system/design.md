...
#### Философия первая: T-образная архитектура данных
...
#### Философия вторая: команда ИИ-сотрудников
...
#### Философия третья: самовоспроизводство знаний
...
```
-- Зафиксировать время начала паузы
sla_paused_at = NOW()
```
...
│ ┌────────────────────────────────────────────────────────┐ │
│ │ KB-T0042 Руководство по диагностике ЧПУ-сервопривода     |
| |                                          Совпадение: 94% │
│ │ Включает: интерпретация кодов аварий, проверка привода   │
│ │ [Просмотр] [Вставить в ответ] [Отметить полезным]        │
│ ├────────────────────────────────────────────────────────┤ │
│ │ KB-T0038 Руководство по обслуживанию серии XYZ-CNC3000 | |
| |                                        Совпадение: 87% │ |
...
### 6.4 Метрики «здоровья» базы знаний

| Метрика | Формула | Порог «здоровья» |
|--------|---------|------------------|
| Охват | Заявки с рекомендациями / всего заявок | > 60% |
| Эффективность | helpful_count / (helpful + not_helpful) | > 75% |
| Цитируемость | Цитируемые статьи / всего опубликованных | > 40% |
| Актуальность | Доля статей, обновлённых за 90 дней | > 50% |
